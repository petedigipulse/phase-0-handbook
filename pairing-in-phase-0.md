...
For Phase 0 (and much of your time as EDA), we will use **Driver-Navigator** pairing.  
...
In Phase 0, we will be **very rigid about roles** for pairing.  Once you enter EDA, you will have more flexibility.  However, we want to ingrain appropriate action for each role.
