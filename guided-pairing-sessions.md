...
Guided Pairing Sessions (GPS) were started with a few goals in mind:
 ...
 3. Prepare students for Dev Academy (EDA) by placing them in a similar scenario to day-to-day life at EDA
...
## Success Guidelines
These sessions are intended to help you become a better pair, have a stronger connection to EDA, and to feel more confident with the material. That said, they are also ways for us to track how you are doing in Phase 0 to this point and will be used as determining factors in whether you will continue through the program or not. Guided Pairing Sessions give us a better idea of whether you will be successful in the program. This is not meant to discourage you or make you think each session is a test. We guage your success based on the following metrics. 
...
2. We want you to know whether you are on the track for success at Dev Academy
